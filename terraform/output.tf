...
output "bucket_name" {
  ...
  value       = aws_s3_bucket.sdee-data-lake.id
}

output "redshift_dns_name" {
  description = "Redshift DNS name."
  value       = aws_redshift_cluster.sdee_redshift_cluster.dns_name
}
...
output "redshift_password" {
  ...
  value       = "sdeeP0ssword0987"
}

output "ec2_public_dns" {
  description = "EC2 public dns."
  value       = aws_instance.sdee_ec2.public_dns
}
